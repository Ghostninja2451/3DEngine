...
void main() 
{
	...
	//sine wave
	//tposition = tposition * (sin(time  + tposition.z * 5) + 2) * 0.2;
	//tposition = tposition * (sin(time  + tposition.x * 5) + 2) * 0.2;
	//tposition = tposition * (sin(time  + tposition.y * 5) + 2) * 0.2;

	// noise
	//tposition = tposition * (noise(time + tposition.z * 3) + 1);
	//tposition = tposition * (noise(time + tposition.x * 3) + 1);
	//tposition = tposition * (noise(time + tposition.y * 3) + 1);
